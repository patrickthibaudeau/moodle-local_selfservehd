    ...
    public static function getDifferenceTimeCreatedTimeReplied($from = null, $to = null) {
        ...
        if (!is_null($from)) {
            ...
            $averageSql = "SELECT AVG(diff) as average_time FROM "
                    . "(SELECT timereplied-timecreated as diff FROM {local_sshd_call_log} WHERE timereplied != 0"
            ...
            $averageSql = "SELECT AVG(diff) as average_time FROM "
                    . "(SELECT timereplied-timecreated as diff FROM {local_sshd_call_log} WHERE timereplied != 0) count ";
